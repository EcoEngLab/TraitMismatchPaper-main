...
d1 <- filter(d_rate, conc=="Aphis gossypii")
...
dp1 <- filter(d_preds, conc=="Aphis gossypii")
...
topt1$species <- as.character("Aphis gossypii")
...
d2 <- filter(d_rate, conc=="Stethorus punctillum")
...
dp2 <- filter(d_preds, conc=="Stethorus punctillum")
...
topt2$species <- as.character("Stethorus punctillum")
...
d3 <- filter(d_rate, conc=="Tetranychus mcdanieli")
...
dp3 <- filter(d_preds, conc=="Tetranychus mcdanieli")
...
topt3$species <- as.character("Tetranychus mcdanieli")
...
d4 <- filter(d_rate, conc=="Aedes camptorhynchus")
...
dp4 <- filter(d_preds, conc=="Aedes camptorhynchus")
...
topt4$species <- as.character("Aedes camptorhynchus")
...
d5 <- filter(d_rate, conc=="Aedes notoscriptus")
...
dp5 <- filter(d_preds, conc=="Aedes notoscriptus")
...
topt5$species <- as.character("Aedes notoscriptus")
...
d6 <- filter(d_rate, conc=="Anthonomus grandis")
...
dp6 <- filter(d_preds, conc=="Anthonomus grandis")
...
topt6$species <- as.character("Anthonomus grandis")
...
d7 <- filter(d_rate, conc=="Corythucha ciliata")
...
dp7 <- filter(d_preds, conc=="Corythucha ciliata")
...
topt7$species <- as.character("Corythucha ciliata")
...
d8 <- filter(d_rate, conc=="Culex annulirostris")
...
dp8 <- filter(d_preds, conc=="Culex annulirostris")
...
d9 <- filter(d_rate, conc=="Lepinotus reticulatus")
...
dp9 <- filter(d_preds, conc=="Lepinotus reticulatus")
...
topt9$species <- as.character("Lepinotus reticulatus")
...
d10 <- filter(d_rate, conc=="Macrocentrus iridescens")
...
dp10 <- filter(d_preds, conc=="Macrocentrus iridescens")
...
topt10$species <- as.character("Macrocentrus iridescens")
...
d11 <- filter(d_rate, conc=="Telenomus isis")
...
dp11 <- filter(d_preds, conc=="Telenomus isis")
...
topt11$species <- as.character("Telenomus isis")
...
d12 <- filter(d_rate, conc=="Bactrocera correcta")
...
dp12 <- filter(d_preds, conc=="Bactrocera correcta")
...
topt12$species <- as.character("Bactrocera correcta")
...
##############################13  and 14 dont work#############################
# ##############################################################################
# Error in Boot(fit_nlsLM13, method = "residual") : 
#   object 'fit_nlsLM16' not found

# #_______________________________________________
# d_fits %>% print(n = Inf)
# 
# d13 <- filter(d_rate, conc=="Cydia pomonella")
# 
...
# 
# 
# dp13 <- filter(d_preds, conc=="Cydia pomonella")
# 
# # plot bootstrapped CIs
# p13 <-  ggplot() +
...
# topt13$species <- as.character("Cydia pomonella")
# 
...
######Error in out[[j]] : subscript out of bounds
# #_______________________________________________
# d_fits %>% print(n = Inf)
# 
# d14 <- filter(d_rate, conc=="Euplectrus ronnai")
# 
...
#   mutate(iter = 1:n()) %>%
#   group_by_all() %>%
#   do(data.frame(temp = seq(min(d14$temp), max(d14$temp), length.out = 100))) %>%
#   ungroup() %>%
#   mutate(pred = sharpeschoolhigh_1981(temp, r_tref, e, eh, th, tref = 15))
# 
# # calculate bootstrapped confidence intervals
...
# 
# 
# dp14 <- filter(d_preds, conc=="Euplectrus ronnai")
# 
# # plot bootstrapped CIs
# p14 <-  ggplot() +
...
# topt14$species <- as.character("Euplectrus ronnai")
# 
...
d15 <- filter(d_rate, conc=="Glyptapanteles muesebecki")
...
dp15 <- filter(d_preds, conc=="Glyptapanteles muesebecki")
...
topt15$species <- as.character("Glyptapanteles muesebecki")
...
###############################################################################
#Error in Boot(fit_nlsLM16, method = "residual") : 
#object 'fit_nlsLM16' not found
# #_______________________________________________
# d_fits %>% print(n = Inf)
# 
# d16 <- filter(d_rate, conc=="Planococcus citri")
# 
...
# 
# 
# dp16 <- filter(d_preds, conc=="Planococcus citri")
# 
# # plot bootstrapped CIs
# p16 <-  ggplot() +
...
# topt16$species <- as.character("Planococcus citri")
# 
...
d17 <- filter(d_rate, conc=="Procambarus clarkii")
...
dp17 <- filter(d_preds, conc=="Procambarus clarkii")
...
topt17$species <- as.character("Procambarus clarkii")
...
d18 <- filter(d_rate, conc=="Sitona discoideus")
...
dp18 <- filter(d_preds, conc=="Sitona discoideus")
...
topt18$species <- as.character("Sitona discoideus")
...
d19 <- filter(d_rate, conc=="Telenomus chrysopae")
...
dp19 <- filter(d_preds, conc=="Telenomus chrysopae")
...
topt19$species <- as.character("Telenomus chrysopae")
...
# d_fits %>% print(n = Inf)
# 
# d20 <- filter(d_rate, conc=="Telenomus lobatus")
# 
...
# 
# 
# dp20 <- filter(d_preds, conc=="Telenomus lobatus")
# 
# # plot bootstrapped CIs
# p20 <-  ggplot() +
...
# topt20$species <- as.character("Telenomus lobatus")
# 
...
d21 <- filter(d_rate, conc=="Tetraneura nigri abdominalis")
...
dp21 <- filter(d_preds, conc=="Tetraneura nigri abdominalis")
...
topt21$species <- as.character("Tetraneura nigri abdominalis")
...
# d_fits %>% print(n = Inf)
# 
# d22 <- filter(d_rate, conc=="Theocolax elegans")
# 
...
# 
# 
# dp22 <- filter(d_preds, conc=="Theocolax elegans")
# 
# # plot bootstrapped CIs
# p22 <-  ggplot() +
...
# topt22$species <- as.character("Theocolax elegans")
# 
...
# 
###############################################################################
#Error in out[[j]][[typelab]] : subscript out of bounds
#_______________________________________________
# d_fits %>% print(n = Inf)
# 
# d23 <- filter(d_rate, conc=="Trichogramma bruni")
# 
...
# 
# 
# dp23 <- filter(d_preds, conc=="Trichogramma bruni")
# 
# # plot bootstrapped CIs
# p23 <-  ggplot() +
...
# d_fits %>% print(n = Inf)
# 
# d24 <- filter(d_rate, conc=="Trichogramma sp. nr. Lutea")
# 
...
# 
# 
# dp24 <- filter(d_preds, conc=="Trichogramma sp. nr. Lutea")
# 
# # plot bootstrapped CIs
# p24 <-  ggplot() +
...
# d_fits %>% print(n = Inf)
# 
# d25 <- filter(d_rate, conc=="Trichogramma sp. nr. Mwanzai")
# 
...
# 
# 
# dp25 <- filter(d_preds, conc=="Trichogramma sp. nr. Mwanzai")
# 
# # plot bootstrapped CIs
# p25 <-  ggplot() +
...
# topt25$species <- as.character("Trichogramma sp. nr. Mwanzai")
# 
...
d26 <- filter(d_rate, conc=="Aedes albopictus")
...
dp26 <- filter(d_preds, conc=="Aedes albopictus")
...
topt26$species <- as.character("Aedes albopictus")
...
dev_topts <- rbind(topt1,topt2,topt3,topt4,topt5,topt6,topt7,topt8,topt9, topt10, topt11, topt12, topt15,
