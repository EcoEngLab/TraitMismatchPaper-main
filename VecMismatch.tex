...
\begin{figure}[H] 
	...
	\caption{{\bf The impact of physiological mismatches in the thermal optima of juvenile and adult life stages on the population growth rate of arthropod vectors. A:} The temperature dependence of  population growth rate with differences in the thermal optima of juvenile traits from adult traits. The thermal dependence of vector density with no mismatch between life stages is displayed as a solid black line. The dashed black line indicates no change in population abundance (zero growth). Blue lines represent how rm varies when adult trait optimum temperatures are higher than juvenile and red line represent mismatches in which the juvenile trait optimum temperatures are higher than the adult trait optimums. Results displayed reflect mismatches between  of $-10^\circ$C to $10^\circ$C. Underlying this patters are the relationships between mismatch and ($T_\text{opt}$) (B) and ($r_\text{opt}$) (C) {\bf B:} The impact of mismatches in the thermal optima of juvenile and adult traits on the thermal optima of the vector population growth rate ($T_\text{opt}$).  {\bf C:} The impact of mismatches in the thermal optima of juvenile and adult traits on the peak vector population growth rate ($r_\text{opt}$). {\bf D:} The relationship between the thermal optimum ($T_\text{opt}$) and range of temperatures for which population growth rate is greater than 0. The dashed line in this panel indicates a scenario in which there are no mismatches between adult and larval TPC.
...
\begin{figure}[H] 
	...
	{\bf B:} The summed contributions of the juvenile and adult life history traits to the temperature dependence of the population growth rate. The vertical dashed line indicates the optimal temperature for the population???}   
\label{fig:r_sens}
\end{figure} 
