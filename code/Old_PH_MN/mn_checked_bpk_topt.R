...
cit <- as.data.frame(unique(final_trait_data$citation))
...
d_rate <- filter(d, adjustedtraitname=="bpk")

d_rate <- filter(d_rate, originaltraitunit=="Eggs/female/day")
...
d_time <- filter(d, adjustedtraitname=="bpk")
d_time <- filter(d_time, originaltraitunit=="nymphs/female/day")
...
d_time2 <- filter(d, adjustedtraitname=="bpk")
d_time2 <- filter(d_time2, originaltraitunit=="eggs per female per day")
...
d_rate <- rbind(d_rate,d_time,d_time2)
